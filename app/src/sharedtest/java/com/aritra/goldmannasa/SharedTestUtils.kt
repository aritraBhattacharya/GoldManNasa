...
class SharedTestUtils {
    ...
    companion object{
        val dummyAPOD:APODEntity = APODEntity(date = "20-12-2021", explanation = "explanation", title = "title", url = "url", hdurl = "hdUrl", media_type = "image", service_version = "v1", isFavourite = false)
        val dummyAPODDto:APODDto = APODDto(date = "20-12-2021", explanation = "explanation", title = "title", url = "url", hdurl = "hdUrl", media_type = "image", service_version = "v1")
        val dummyDate:String = "2022-12-12"

        val fakeWorkingDao = object :ApodDao{
